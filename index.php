...
<div class="main-body">
			<div class="container introduction-container col-md-10 col-md-offset-1 ">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
                        <h4><text class="text-primary">Bio</text></h4>
                        <p class="lead">
        ...
        <div class="container introduction-container col-md-10 col-md-offset-1">
                ...
                <div class="row">
                  <h4><text class="text-primary">Welcome to join us!</text></h4>

                    <p class="lead">Welcome to join <text class="text-primary"><a href='lab.php'>Game, Control & Intelligence (GCI) Lab</a></text>, as Masster Student or Research Assistants.
                        <br> Feel free to contact to me at <text class='text-primary'>chgiang@mail.mcut.edu.tw</text>. <br>
                  In the email, please include:  your CV (with education background, research experience) and your research interests<br>
                  <text class='text-danger'>Financial support: school scholarship and additional financial support from a research project.</text>
                </p>
    ...
    <div class="row education-item">
            <text class='text-primary'><b>2023-2024: Postdoc</b></text><br>
            <text class='text-secondary'>&emsp;Center of Artificial Intelligence and Data Science</text><br>
            <text class='text-secondary'>&emsp;Ming Chi University of Technology, Taiwan</text><br>
    </div>
    <div class="row education-item">
